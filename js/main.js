let [chooseLevel, levelDetails, subtitle, result, trickName, trickImage] = ['choose-level', 'level-details', 'subtitle', 'result', 'trick-name', 'trick-image'].map(id => document.getElementById(id));
...
function beginnerResult() {
    ...
    chooseLevel.classList.add('hidden');
    chooseLevel.classList.remove('visible');
    result.classList.add('visible');
    result.classList.remove('hidden');
    subtitle.innerHTML = 'Your 2021 Goal is...';
...
function intermediateResult() {
    ...
    result.classList.add('visible');
    result.classList.remove('hidden');
    subtitle.innerHTML = 'Your 2021 Pole Goal is...';
    trickName.innerHTML = trick;
    trickImage.src = image;
};
...
function explainLevels() {
    levelDetails.classList.toggle('visible');
    levelDetails.classList.toggle('hidden');
}

function reset() {
    chooseLevel.classList.remove('hidden');
    chooseLevel.classList.add('visible');
    subtitle.innerHTML = 'What pole trick should you master this year?';
